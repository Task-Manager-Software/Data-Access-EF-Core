        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowCompletedTasks = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RemindDateUTC = table.Column<DateTime>(nullable: true),
                    DueDateUTC = table.Column<DateTime>(nullable: true),
                    RepeatType = table.Column<byte>(nullable: false),
                    SelectedWeekDays = table.Column<byte>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccountTasks_Tasks_TaskId",
                        column: x => x.TaskId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountProjects_AccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountTasks_AccountId",
                table: "AccountTasks",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_AccountTasks_TaskId",
                table: "AccountTasks",
                column: "TaskId");
